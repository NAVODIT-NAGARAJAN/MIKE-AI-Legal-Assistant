...
export const Register: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex bg-[#0A0A0A] flex-row-reverse">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#111111] relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
           <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-[#D4AF37] blur-[100px]" />
           <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-[#D4AF37] blur-[100px]" />
        </div>
        ...
        <motion.div 
          ...
          className="relative z-10 flex flex-col items-end space-y-3"
        >
        ...
        <div className="relative z-10 space-y-8 max-w-md ml-auto text-right">
          ...
          <div className="space-y-6 pt-8 border-t border-[#2A2A2A] inline-block text-left">
        ...
        <div className="relative z-10 text-[#B3B3B3] text-sm text-right">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 bg-[#0A0A0A]/50">
        ...
        >
          ...
          <p className="text-center text-sm text-[#B3B3B3] mt-8">
            ...
            <Link to="/login" className="font-semibold text-[#D4AF37] hover:text-[#D4AF37] transition-colors">
              Sign in
            </Link>
          </p>
        </motion.div>
